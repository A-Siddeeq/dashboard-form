    ...
    <div className="flex flex-col xl:mx-12 bg-white xl:w-[900px]">
      ...
      <table className="min-w-full bg-white border ml-[-20px] border-gray-200">
        <thead>
          <tr className="border-b border-b-[#EEEEEE]">
            ...
            <th className="font-[500] xl:text-[14px] xl:leading-[33px] text-[#B5B7C0]">Company</th>
            <th className="font-[500] xl:text-[14px] xl:leading-[33px] text-[#B5B7C0]">Phone Number</th>
            <th className="font-[500] xl:text-[14px] xl:leading-[33px] text-[#B5B7C0]">Email</th>
            <th className="font-[500] xl:text-[14px] xl:leading-[33px] text-[#B5B7C0]">Country</th>
            <th className="font-[500] xl:text-[14px] xl:leading-[33px] text-[#B5B7C0]">Status</th>
          </tr>
        </thead>
        <tbody>
          {filteredCustomers.map((customer, index) => (
            <tr className="border-b border-b-[#EEEEEE]" key={index}>
              <td className="font-[500] text-[12px] xl:text-[14px] text-[#292D32] xl:leading-[33px] xl:px-2 py-2">{customer.name}</td>
              <td className="font-[500] text-[12px] xl:text-[14px] text-[#292D32] xl:leading-[33px]">{customer.company}</td>
              <td className="font-[500] text-[12px] xl:text-[14px] text-[#292D32] xl:leading-[33px]">{customer.phone}</td>
              <td className="font-[500] text-[12px] xl:text-[14px] text-[#292D32] xl:leading-[33px]">{customer.email}</td>
              <td className="font-[500] text-[12px] xl:text-[14px] text-[#292D32] xl:leading-[33px]">{customer.country}</td>
              <td className="font-[500] text-[12px] xl:text-[14px] text-[#292D32] xl:leading-[33px]">
                <button className={`font-[500] xl:text-[14px] rounded-md border py-1 px-1 xl:px-3 leading-[21px] xl:w-[80px] ${customer.status === 'Active' ? 'bg-[#16C09861] border-[#00B087] text-[#00B087]' : 'bg-[#FFC5C5] border-[#DF0404] text-[#DF0404]'}`}>
                  {customer.status}
                </button>
              </td>
            </tr>
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex gap-x-2">
          <button className="bg-[#F5F5F5] text-[#404B52] text-[12px] xl:text-[16px] xl:px-2.5 xl:py-1.5 border rounded-sm">{"<"}</button>
