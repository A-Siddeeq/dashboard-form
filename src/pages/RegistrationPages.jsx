 ...
 const Pages = (index) => {
    ...
    <StepOne key={0} next={handleNextStep} data={userData}/>,
     <StepTwo key={1} prev={handlePrevStep} next={handleNextStep} data={userData}/>,
      <StepThree key={2} prev={handlePrevStep} next={handleNextStep} data={userData}/>,
      <StepFour key={3} prev={handlePrevStep} next={handleNextStep} data={userData}/>,
      <SignedUp key={4} />
    ]
...
const StepOne = (props) => {
    ...
    <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-sm">
      <div className="flex justify-between mb-4">
        <ul className="flex">
          <li className="-mb-px mr-1">
            <a className="bg-white inline-block border-[#EF498F] border-b py-2 px-4 text-[#1A0710D9] font-[400px] leading-[24px]" href="#">Register</a>
          </li>
          <li className="mr-1">
            <Link to={'/login'} className="bg-white inline-block py-2 px-4 text-gray-500 hover:text-blue-800 font-semibold" href="#">Log in</Link>
          </li>
        </ul>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd" d="M6.70699 5.29298C6.51839 5.11082 6.26579 5.01003 6.00359 5.01231C5.74139 5.01458 5.49058 5.11975 5.30517 5.30516C5.11976 5.49057 5.01459 5.74138 5.01232 6.00358C5.01004 6.26578 5.11083 6.51838 5.29299 6.70698L10.586 12L5.29299 17.293C5.19748 17.3852 5.1213 17.4956 5.06889 17.6176C5.01648 17.7396 4.98889 17.8708 4.98774 18.0036C4.98659 18.1364 5.01189 18.268 5.06217 18.3909C5.11245 18.5138 5.1867 18.6255 5.28059 18.7194C5.37449 18.8133 5.48614 18.8875 5.60904 18.9378C5.73193 18.9881 5.86361 19.0134 5.99639 19.0122C6.12917 19.0111 6.26039 18.9835 6.38239 18.9311C6.5044 18.8787 6.61474 18.8025 6.70699 18.707L12 13.414L17.293 18.707C17.4816 18.8891 17.7342 18.9899 17.9964 18.9877C18.2586 18.9854 18.5094 18.8802 18.6948 18.6948C18.8802 18.5094 18.9854 18.2586 18.9877 17.9964C18.9899 17.7342 18.8891 17.4816 18.707 17.293L13.414 12L18.707 6.70698C18.8891 6.51838 18.9899 6.26578 18.9877 6.00358C18.9854 5.74138 18.8802 5.49057 18.6948 5.30516C18.5094 5.11975 18.2586 5.01458 17.9964 5.01231C17.7342 5.01003 17.4816 5.11082 17.293 5.29298L12 10.586L6.70699 5.29298Z" fill="#1A0710" fillOpacity="0.85"/>
          </svg>
      </div>
      ...
      <div className="flex items-center justify-start gap-2 mb-4">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M15.6113 0C15.8313 1.49418 15.2231 2.95799 14.4208 3.99365C13.5624 5.10453 12.0829 5.96372 10.6495 5.91888C10.3878 4.48834 11.0578 3.0144 11.873 2.02359C12.7673 0.930068 14.3 0.0911264 15.6113 0ZM19.9175 21.0314C20.6565 19.8988 20.9326 19.3274 21.5062 18.0488C17.3338 16.462 16.6652 10.5301 20.7945 8.25341C19.535 6.67389 17.7651 5.75828 16.0944 5.75828C14.8906 5.75828 14.0658 6.07243 13.3159 6.35803C12.691 6.59603 12.1182 6.81419 11.4216 6.81419C10.6687 6.81419 10.002 6.57515 9.30392 6.32485C8.53683 6.04981 7.73182 5.76118 6.73292 5.76118C4.85804 5.76118 2.86238 6.90677 1.59713 8.86526C-0.181423 11.6236 0.121951 16.8092 3.00616 21.2266C4.03706 22.8076 5.41446 24.5838 7.21602 24.5998C7.96355 24.6072 8.46099 24.3841 8.99929 24.1426C9.61542 23.8663 10.2851 23.5659 11.4446 23.5598C12.6109 23.5528 13.27 23.8568 13.8779 24.1372C14.4024 24.3791 14.8888 24.6035 15.63 24.5954C17.433 24.581 18.8866 22.6123 19.9175 21.0314Z" fill="#0B0B0A"/>
        </svg>
        </div>
        <div  className="flex justify-center items-center bg-[#F6F6F6] p-2 rounded-[50%] w-[48px] h-[48px]">
          <svg width="13" height="27" viewBox="0 0 13 27" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M8.50155 26.1115V13.0542H12.1059L12.5836 8.5546H8.50155L8.50768 6.30251C8.50768 5.12894 8.61918 4.50012 10.3048 4.50012H12.5581V0H8.95319C4.62314 0 3.09907 2.18279 3.09907 5.85357V8.55511H0.4V13.0547H3.09907V26.1115H8.50155Z" fill="#3B5998"/>
          </svg>
        </div>
        <div  className="flex justify-center items-center bg-[#F6F6F6] p-2 rounded-[50%] w-[48px] h-[48px]">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11 4.62131C12.9529 4.62131 14.2702 5.46486 15.0213 6.16975L17.9564 3.30398C16.1538 1.62842 13.808 0.599976 11 0.599976C6.93244 0.599976 3.41955 2.9342 1.70933 6.33153L5.072 8.94309C5.91555 6.43553 8.24978 4.62131 11 4.62131Z" fill="#EA4335"/>
        <path d="M20.984 11.2311C20.984 10.376 20.9147 9.75197 20.7644 9.10486H11V12.9644H16.7316C16.616 13.9235 15.992 15.368 14.6053 16.3386L17.8871 18.8809C19.8516 17.0666 20.984 14.3973 20.984 11.2311Z" fill="#4285F4"/>
        <path d="M5.08355 13.0569C4.864 12.4098 4.73689 11.7164 4.73689 11C4.73689 10.2835 4.864 9.59021 5.072 8.9431L1.70933 6.33154C1.00444 7.74132 0.599998 9.32443 0.599998 11C0.599998 12.6755 1.00444 14.2587 1.70933 15.6684L5.08355 13.0569Z" fill="#FBBC05"/>
        <path d="M11 21.4C13.808 21.4 16.1653 20.4756 17.8871 18.8809L14.6053 16.3387C13.7271 16.9511 12.5484 17.3787 11 17.3787C8.24977 17.3787 5.91555 15.5644 5.08355 13.0569L1.72089 15.6684C3.43111 19.0658 6.93244 21.4 11 21.4Z" fill="#34A853"/>
        </svg>
      ...
      <Form>
        <div className="mb-4">
          <Field className="border rounded w-full h-[56px] py-2 px-3 text-gray-700 font-[400] text-[16px] leading-[24px] focus:outline-none focus:shadow-outline" placeholder="Email address" name='email'/>
        ...
        <div className="mt-4">
            ...
            <span className="ml-2 text-gray-700">Send me news and promotions</span>
          
        </div>
        
        <p className="text-center text-gray-500 text-xs mt-4">
          By continuing I agree with the <a href="#" className="text-blue-500">Terms & Conditions</a> and <a href="#" className="text-blue-500">Privacy Policy</a>.
        </p>
      </Form>
      </Formik>
    </div>
     ...
     <div className="flex mb-4 gap-2">
      ...
      <Form>
        <div className="mb-4">
          ...
          <Field className="border rounded w-full h-[56px] py-2 px-3 text-gray-700 font-[400] text-[16px] leading-[24px] focus:outline-none focus:shadow-outline"  type="text" placeholder="Full Name" name='full_name' />
          <ErrorMessage name="full_name" component="div" className="text-red-500 text-xs" />
        </div>
     ...
     <div className="flex mb-4 gap-2">
      ...
      <Form>
        <div className="flex flex-col justify-center mb-4"> 
          ...
          <Field className="border rounded w-full h-[56px] py-2 px-3 text-gray-700 font-[400] text-[16px] leading-[24px] focus:outline-none focus:shadow-outline placeholder:pl-5"  placeholder="Search for address" name='address' />
        ...
        <div className='flex flex-col justify-end'>
          ...
          <p className='font-[400] text-[15px] leading-[24px] text-[#1A0710D9]'>Estimated shopping costs</p>
          </div>
        </div>
...
const StepFour = (props) => {
  ...
  async function handleSubmit(values, { setSubmitting }) {
    try {
      ...
      props.next(values)
      console.log('data', userData, `user ${values.email} and ${values.password} registered as ${values.full_name}`)
    } catch (error) {
    ...
    <div className='flex justify-between'>
     <div className="flex mb-4 gap-2">
      ...
      <Formik
         ...
         <Form>
        <div className="mb-4">
          <Field className="border rounded w-full h-[56px] py-2 px-3 text-gray-700 font-[400] text-[16px] leading-[24px] focus:outline-none focus:shadow-outline"  placeholder="Street Address" name="street_address"/>
          <ErrorMessage name="street_address" component="div" className="text-red-500 text-xs" />
        </div>
        <div className="mb-4">
          <div className="relative">
            <Field className="border rounded w-full h-[56px] py-2 px-3 text-gray-700 font-[400] text-[16px] leading-[24px] focus:outline-none focus:shadow-outline"  placeholder="Apartment" name="apartment" />
        ...
        <div className="mb-4">
          <Field className="border rounded w-full h-[56px] py-2 px-3 text-gray-700 font-[400] text-[16px] leading-[24px] focus:outline-none focus:shadow-outline"  placeholder="City" name="city" />
          <ErrorMessage name="city" component="div" className="text-red-500 text-xs" />
        </div>

        <div className="flex justify-between mb-4">
          <Field className="border rounded w-[45%] h-[56px] py-2 px-3 text-gray-700 font-[400] text-[16px] leading-[24px] focus:outline-none focus:shadow-outline"  placeholder="State" name="state"/>
          <ErrorMessage name="state" component="div" className="text-red-500 text-xs" />
          <Field className="border rounded w-[45%] h-[56px] py-2 px-3 text-gray-700 font-[400] text-[16px] leading-[24px] focus:outline-none focus:shadow-outline"  placeholder="Zip code" name="zip_code"/>
  ...
  const submit =()=>{
   navigate('/login')
    ...
    <div className="bg-white rounded-lg shadow-md w-full max-w-sm">
      ...
      <div className='p-6'>
        <h1 className='text-center font-[700] text-[44px] leading-[48px] text-[#1A0710D9] py-4'>You are successfully registered!</h1>
        <div className="flex flex-auto items-center justify-center" >
          <button className="w-full bg-[#5932EA] hover:bg-[#9962EF] py-2 mt-4 px-4 rounded-xl focus:outline-none focus:shadow-outline tracking-[0.15px] text-white font-[700] text-[16px] leading-[24px]" type="button" onClick={submit}>
          Go to Login
          </button>
        </div>
        </div>
