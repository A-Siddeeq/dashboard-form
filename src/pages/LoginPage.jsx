        ...
        <div className="flex mb-4 justify-between">
          <ul className="flex">
            <li className="-mb-px mr-1">
              <Link to="/register" className="bg-white text-gray-500 inline-block py-2 px-4 hover:text-blue-800 font-semibold">
                Register
              </Link>
            </li>
            <li className="mr-1">
              <p className="bg-white inline-block border-[#EF498F] border-b py-2 px-4 text-[#1A0710D9] font-[400px] leading-[24px]" href="#">
                Log in
              </p>
            </li>
          </ul>
