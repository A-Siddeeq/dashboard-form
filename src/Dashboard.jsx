        ...
        <div className={`flex flex-col items-center gap-y-2 pl-2 xl:pl-0 xl:w-[300px] ${isMenuOpen ? 'hidden' : ''}`}>
              ...
              <div className='flex flex-col justify-around bg-gradient-to-r from-[#EAABF0] to-[#4623E9] rounded-[20px] w-[250px] h-[150px] p-3 xl:mt-[-20px]'>  
                ...
                <div className='flex items-center'>
                    ...
                    <path d="M1 1L7 7L13 1" stroke="#757575" stroke-width="2" stroke-linecap="round" strokeLinejoin="round"/>
                    </svg>
            ...
            <div className='flex justify-center md:justify-start gap-x-1 xl:justify-between'>
                <div className='flex  md:flex-row md:gap-x-2 tracking-wide'>
                    ...
                    <div className='flex flex-col gap-0.5'>
                        <p className='text-[#ACACAC] font-[400] text-[14px] leading-[21px]'>Total Customers</p>
                        <p className='text-[#333333] font-[600] text-[32px] leading-[32px]'>5,423</p>
                        <div className='flex items-center gap-x-1'>
                        <div className='flex items-center gap-x-1'> 
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 17L10 5" stroke="#00AC4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M4.16663 9.99996L9.99996 4.16663L15.8333 9.99996" stroke="#00AC4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span className='font-[700] text-[#00AC4F] text-[12px] leading-[18px]'>16%</span></div>
                         <div className='font-[400] text-[12px] leading-[18px]'> this month</div>
                         </div>
                    </div>
                    ...
                    <div className='flex flex-col gap-0.5'>
                        ...
                        <p className='text-[#ACACAC] font-[400] text-[14px] leading-[21px]'>Members</p>
                        <p className='text-[#333333] font-[600] text-[32px] leading-[32px]'>1,893</p>
                        <div className='flex items-center gap-x-1'>
                        <div className='flex items-center gap-x-1'> 
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 3L10 15" stroke="#D0004B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.8334 10L10 15.8334L4.16671 10" stroke="#D0004B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span className='font-[700] text-[#D0004B] text-[12px] leading-[18px]'>1%</span></div>
                         <div className='font-[400] text-[12px] leading-[18px]'> this month</div>
                         </div>
                    </div>
                    ...
                    <div className='flex flex-col gap-0.5'>
                        <p className='text-[#ACACAC] font-[400] text-[14px] leading-[21px]'>Active Now</p>
                        <p className='text-[#333333] font-[600] text-[32px] leading-[32px]'>189</p>
                        <div className='flex items-center gap-x-1'>
                        <div className='flex items-center gap-x-1'> 
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 17L10 5" stroke="#00AC4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
